        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Your one-stop shop for everything. Quality products, seamless shopping.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/returns" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">
                  Returns
                </Link>
              </li>
            </ul>
